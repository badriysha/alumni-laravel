...
<link rel="stylesheet" type="text/css" media="all" href="{{ url('backend/css/waves.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('backend/css/feather.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ url('backend/css/widget.css') }}">