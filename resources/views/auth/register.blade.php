        ...
        <div class="sufee-login d-flex align-content-center flex-wrap">
            <div class="container">
                <div class="login-content">
                    ...
                    <div class="login-form" style="font-size: 14px; padding: 40px 30px">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password (Min. 8 Karakter)" name="password" id="password" required autocomplete="new-password">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Password Confirmation" id="password-confirm" name="password_confirmation" required autocomplete="new-password">
                            </div>
                            <button type="submit" class="btn my-3 text-white" style="background-color: #0E7165; letter-spacing: 1px;">register</button>
                            <div class="register-link mt-2 text-center">
                                <p>or<a href="{{ route('register') }}"> Sign in</a></p>
                            </div>
                        </form>
                    </div>
                </div>
