                ...
                <div class="page-body">
                    ...
                    <div class="card">
                      <div class="card-block">
                        <a href="{{ route('event.create') }}"><button class="btn btn-sm btn-primary">Create Event</button></a>
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td class="text-center">
                                          <a href="{{ route('event.edit', $item->id) }}" class="text-primary">
                                            <span class="icofont icofont-ui-edit"></span>
                                          </a>
                                          <a href="{{ route('event.destroy', $item->id) }}" class="text-danger px-2" onclick="event.preventDefault();document.getElementById('destroy-form').submit();">
                                            <i class="fa fa-trash"></i>
                                          </a>
                                          <form id="destroy-form" action="{{ route('event.destroy', $item->id) }}" method="POST" style="display: none">
                                          @csrf
                                          </form>
                                        </td>
                                      </tr>
