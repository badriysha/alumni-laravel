      ...
      <div class="page-header float-left">
          <div class="page-title">
              <ol class="breadcrumb text-left" style="font-size: 14px; font-weight: 300;">
                ...
                <li><a href="#">Post</a></li>
                <li class="active" style="font-weight: 400;">Daftar Acara</li>
              </ol>
          </div>
      </div>
  </div>
                ...
                <div class="card-header">
                    <div class="row d-inline">
                      ...
                      <div class="col-sm-8 col-md-8">
                        <a href="{{ route('event.create') }}" class="btn btn-primary btn-sm float-right ml-2"><i class="fa fa-plus"></i>&nbsp; Create Event</a>
                      </div>
                    </div>
                </div>
                <div class="card-body">
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered" style="width: 100%">
                        ...
                        <tbody>
                          ...
                          <tr style="font-weight: 300; font-size: 14px;">
                              ...
                              <td>
                                  <a href="{{ route('event.edit', $item->id) }}" class="btn btn-info btn-sm">
