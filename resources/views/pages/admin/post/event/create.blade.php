            ...
            <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="enter event title">
                        </div>
                        <div class="form-group mt-4">
                        ...
                        <div class="form-group mt-5">
                            <textarea name="desc" rows="10" class="form-control">{{ old('desc') }}</textarea>
                        </div>
