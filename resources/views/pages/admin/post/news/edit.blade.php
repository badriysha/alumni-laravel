            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="icon-book-open"></i></a></li>
                                ...
                                <div class="card-block">
                                    <form action="{{ route('news.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="post_date" class="form-control" type="date" value="{{ $item->post_date }}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" id="editor" name="news_entry">{{ $item->news_entry }}</textarea>
                                        </div>
