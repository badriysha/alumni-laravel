            ...
            <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="post_date" value="{{ old('post_date') }}" placeholder="Tanggal">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-10 col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="enter news title">
                        </div>
                        <div class="form-group mt-4">
                        ...
                        <div class="form-group mt-5">
                            <textarea name="news_entry" rows="10" class="form-control">{{ old('news_entry') }}</textarea>
                        </div>
